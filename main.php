...
Version: 1.1.8
Author: Joe Anzalone, blubrry, amandato
...
function get_excerpt_by_id($post, $length = 10, $tags = '<a><em><strong>', $extra = ' . . .') {
	...
	function __construct(){
		...
		add_shortcode( 'message-flow', array($this,'shortcode') ); // backwards compatibility
		add_shortcode( 'message_flow', array($this,'shortcode') ); 
